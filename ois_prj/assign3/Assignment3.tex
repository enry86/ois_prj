...
% Class Diagram
% =================
\input{assign3/sections/classDiags}
...
Of all the operations described above, only the most important have been modeled, in particular are:
\begin{itemize}
...
\input{assign3/sections/Administrative}
\input{assign3/sections/Project}
\input{assign3/sections/Course}
\input{assign3/sections/Commercial}
\input{assign3/sections/Resource}
\input{assign3/sections/Documentation}
